...
namespace Tic_Tac_Toe
{
    public partial class Form1 : Form
    {
        ...
        private void score_btn(Button TempButton1, Button TempButton2, Button TempButton3,String Btn_Text)
        {
            ...
            TempButton2 = Color.PowderBlue;
            TempButton3 = Color.PowderBlue;
            if (Btn_Text == "X")
            {
        ...
        {
            //******************************((horizontal))*******************************************
            if (button1.Text ==  button2.Text && button2.Text == button3.Text ) score_btn(button1, button2, button3, button1.Text);
            else if (button4.Text == button5.Text && button5.Text== button6.Text ) score_btn(button4, button5, button6, button4.Text);
            else if (button7.Text == button8.Text && button8.Text== button9.Text) score_btn(button7, button8, button9, button7.Text);
            //*******************************((vertical ))********************************************
            else if (button1.Text == button4.Text && button4.Text== button7.Text) score_btn(button1, button2, button7, button1.Text);
            else if (button2.Text == button5.Text && button5.Text == button8.Text) score_btn(button2, button5, button8, button2.Text);
            else if (button3.Text == "X" && button6.Text == "X" && button9.Text == "X") score_btn(button3, button6, button9, button3.Text);
            //**************************************((diagonal))*************************************
            else if (button1.Text == button5.Text && button5.Text == button9.Text) score_btn(button1, button5, button9, button1.Text);
            else if (button3.Text == button5.Text && button5.Text == button7.Text) score_btn(button3, button5, button7, button3.Text);
            //*******************************((No_Win))********************************************
